...
class MaterialTheme {
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      primaryFixedDim: Color(0xff176042),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff246a4b),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff025437),
      onPrimaryContainer: Color(0xffffffff),
      secondary: Color(0xff1c3025),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff384e41),
      onSecondaryContainer: Color(0xffffffff),
      ...
      inverseSurface: Color(0xff2c322e),
      inversePrimary: Color(0xff8fd5af),
      primaryFixed: Color(0xff025437),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff003b25),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff384e41),
      onSecondaryFixed: Color(0xffffffff),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryFixedDim: Color(0xffa4cddd),
      onTertiaryFixedVariant: Color(0xff0f3b48),
      surfaceDim: Color(0xff0f1511),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.dark,
      primary: Color(0xffbbffd8),
      surfaceTint: Color(0xff8fd5af),
      onPrimary: Color(0xff000000),
      primaryContainer: Color(0xff8bd1ab),
